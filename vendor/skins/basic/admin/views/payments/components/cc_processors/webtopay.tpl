{* $Id: webtopay.tpl 6560 2008-12-15 11:41:36Z zeke $ *}

{assign var="return_url" value="`$config.http_location`/payments/webtopay.php"}
<p style="display: none;">{$lang.text_webtopay_notice|replace:"[return_url]":$return_url}</p>
<hr />

<div class="form-field">
	<label for="account_id">WebToPay Project ID:</label>
